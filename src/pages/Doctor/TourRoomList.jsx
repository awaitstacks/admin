...
//                           <div
//                             className={`inline-block mx-auto px-6 py-2 rounded-full font-semibold text-sm ${room.occupants.length === 1
...
//                               (p.age && p.age < 12) ||
//                               p.sharingType?.toLowerCase().includes("berth");
...
//                     onChange={(e) => {
//                       const newOcc = [...formData.occupants];
//                       newOcc[index].gender = e.target.value;
//                       setFormData({ ...formData, occupants: newOcc });
//                     }}
//                   >
...
//                       <div className="mobile">Mob: {room.contactMobile}</div>
//                       <div className="sharing">
//                         {getSharingLabel(room.occupants.length)} SHARING                      </div>
//                     </div>
//                     {room.occupants.map((p, i) => {
//                       const gender = p.gender || "Male";
//                       let extra = "";
//                       const isChild = p.isChild === true ||
//                         (p.age && p.age < 12) ||
//                         p.category?.toLowerCase() === "child" ||
//                         p.sharingType?.toLowerCase().includes("berth");

//                       if (isChild) extra = " • Child";

//                       return (
//                         <div className="guest" key={i}>
//                           {p.firstName} {p.lastName} ({gender}{extra})
//                         </div>
//                       );
//                     })}
